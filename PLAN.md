...
| Component | Gap |
|-----------|-----|
| WPT harness | **Phase 24 complete** (285/353 passing, 0 fail, 68 skip). Phase 24: createCDATASection NotSupportedError, createEvent whitelist+throw, TreeWalker.html unskip. Remaining 68 skipped need Shadow DOM event retargeting, workers, advanced iframes, XML/XHTML, custom elements, or missing APIs (Selection, PointerEvent, XMLHttpRequest). |
