...
**75 skipped tests by category:**
- **nodes-other** (13): surrogates, characterSet, cloneNode edge cases, remove-unscopable, DOMStringMap
- **events-other** (10): Body/FrameSet handlers, dispatch-order, focus, pointer, handler-count
...
| Component | Gap |
|-----------|-----|
| WPT harness | **Phase 21 complete** (278/353 passing, 0 fail, 75 skip). Phase 21: StaticRange, extract_node TypeError fix, MouseEvent offsetX/offsetY, skip cleanup. Remaining 75 skipped need Shadow DOM event retargeting, workers, advanced iframes, XML/XHTML, custom elements, or missing APIs (DOMStringMap, Selection, PointerEvent, FocusEvent). |
