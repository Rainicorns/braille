...
- **collections** (1): HTMLCollection-as-prototype (Proxy prototype chain). DOMStringMap now passing.
...
| Component | Gap |
|-----------|-----|
| WPT harness | **Phase 22 complete** (279/353 passing, 0 fail, 74 skip). Phase 22: WheelEvent properties+proto chain, KeyboardEvent properties, DOMStringMap proxy. Remaining 74 skipped need Shadow DOM event retargeting, workers, advanced iframes, XML/XHTML, custom elements, or missing APIs (Selection, PointerEvent, FocusEvent). |
