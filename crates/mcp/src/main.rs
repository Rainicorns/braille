...
impl ServerHandler for BrailleServer {
    fn get_info(&self) -> ServerInfo {
        ...
        info.instructions = Some(
            "Braille is a text-mode browser engine. Use braille_browse to start a session, \
             then interact with the page using click/type/select/snap/eval. Close sessions \
             when done."
                .into(),
        );
        info
